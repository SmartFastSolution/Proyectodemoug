...
function(e, t) {
	...
	E.fn = E.prototype = {
		...
		var e, t, n, i, r, o, s = arguments[0] || {},
			...
			l = arguments.length,
			c = !1;
		for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || v(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (e = arguments[a])) for (t in e) n = s[t], s !== (i = e[t]) && (c && i && (E.isPlainObject(i) || (r = Array.isArray(i))) ? (o = r ? (r = !1, n && Array.isArray(n) ? n : []) : n && E.isPlainObject(n) ? n : {}, s[t] = E.extend(c, o, i)) : void 0 !== i && (s[t] = i));
		return s
	}, E.extend({
	...
	var f = function(n) {
		...
		for (e in f = oe.support = {}, r = oe.isXML = function(e) {
			...
			}), g = g.length && new RegExp(g.join("|")), a = a.length && new RegExp(a.join("|")), t = K.test(s.compareDocumentPosition), y = t || K.test(s.contains) ?
			function(e, t) {
					...
					function(e) {
						...
						if (u) {
							...
							if (l = [v ? u.firstChild : u.lastChild], v && d) {
								for (f = (a = (i = (r = (o = (s = u)[E] || (s[E] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === k && i[1]) && i[2], s = a && u.childNodes[a]; s = ++a && s && s[c] || (f = a = 0) || l.pop();) if (1 === s.nodeType && ++f && s === e) {
									r[p] = [k, a, f];
									break
								}
							} else if (d && (f = a = (i = (r = (o = (s = e)[E] || (s[E] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === k && i[1]), !1 === f) for (;
			...
			pseudos: {
				...
				lang: ae(function(n) {
					return B.test(n || "") || oe.error("unsupported lang: " + n), n = n.replace(J, ee).toLowerCase(), function(e) {
						var t;
						do {
		...
		function ve(a, e, t) {
			...
			function(e, t, n) {
				...
				for (; e = e[l];) if (1 === e.nodeType || h) if (r = (o = e[E] || (e[E] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), c && c === e.nodeName.toLowerCase()) e = e[l] || e;
				else {
		...
		function be(e) {
			for (var r, t, n, i = e.length, o = w.relative[e[0].type], s = o || w.relative[" "], a = o ? 1 : 0, l = ve(function(e) {
				...
				return r = null, i
			}]; a < i; a++) if (t = w.relative[e[a].type]) u = [ve(xe(u), t)];
			else {
		...
		return ge.prototype = w.filters = w.pseudos, w.setFilters = new ge, p = oe.tokenize = function(e, t) {
			...
			if (!s) {
				...
				(s = M(e, (g = o, y = r, v = 0 < y.length, x = 0 < g.length, i = function(e, t, n, i, r) {
					...
					for (r && (_ = t === S || t || r); c !== m && null != (o = f[c]); c++) {
						if (x && o) {
							for (s = 0, t || o.ownerDocument === S || (b(o), n = !T); a = g[s++];) if (a(o, t || S, n)) {
								i.push(o);
								break
							}
							r && (k = p)
			...
			if (n = n || [], 1 === u.length) {
				...
				for (r = G.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !w.relative[a = s.type]);) if ((l = w.find[a]) && (i = l(s.matches[0].replace(J, ee), Z.test(o[0].type) && me(t.parentNode) || t))) {
	...
	(E.fn.init = function(e, t, n) {
		...
		if (i[1]) {
			if (t = t instanceof E ? t[0] : t, E.merge(this, E.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : T, !0)), C.test(i[1]) && E.isPlainObject(t)) for (i in t) v(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
			return this
		}
	...
	function ye(e, t, n, i, r) {
		for (var o, s, a, l, c, u, h = t.createDocumentFragment(), d = [], f = 0, p = e.length; f < p; f++) if ((o = e[f]) || 0 === o) if ("object" === _(o)) E.merge(d, o.nodeType ? [o] : o);
		else if (ge.test(o)) {
		...
		for (h.textContent = "", f = 0; o = d[f++];) if (i && -1 < E.inArray(o, i)) r && r.push(o);
	...
	E.event = {
		...
		add: function(t, e, n, i, r) {
			...
			if (g) for (n.handler && (n = (o = n).handler, r = o.selector), r && E.find.matchesSelector(ve, r), n.guid || (n.guid = E.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function(e) {
		...
		remove: function(e, t, n, i, r) {
			...
			if (g && (l = g.events)) {
				for (c = (t = (t || "").match(H) || [""]).length; c--;) if (f = m = (a = _e.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), f) {
	...
	function Ie(n, i, r, o) {
		...
		if (h && (t = (e = ye(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
			...
			if (a) for (c = s[s.length - 1].ownerDocument, E.map(s, Ne), u = 0; u < a; u++) l = s[u], ue.test(l.type || "") && !$.access(l, "globalEval") && E.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? E._evalUrl && E._evalUrl(l.src) : w(l.textContent.replace(De, ""), c, l))
		}
		return n
	}
	function He(e, t, n) {
	...
	E.extend({
		...
		clone: function(e, t, n) {
			...
			if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e))) for (s = de(u), i = 0, r = (o = de(e)).length; i < r; i++) a = o[i], l = s[i], void 0, "input" === (c = l.nodeName.toLowerCase()) && le.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
			if (t) if (n) for (o = o || de(e), s = s || de(u), i = 0, r = o.length; i < r; i++) Le(o[i], s[i]);
			else Le(e, u);
	...
	function lt(o, e, t) {
		...
		for (function(e, t) {
			var n, i, r, o, s;
			for (n in e) if (r = t[i = B(n)], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = E.cssHooks[i]) && "expand" in s) for (n in o = s.expand(o), delete e[i], o) n in e || (e[n] = o[n], t[n] = r);
			else t[i] = r
		}(u, c.opts.specialEasing); i < r; i++) if (n = lt.prefilters[i].call(c, o, u, c.opts)) return v(n.stop) && (E._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
	...
	E.Animation = E.extend(lt, {
		...
		prefilters: [function(e, t, n) {
			...
			if ((l = !E.isEmptyObject(t)) || !E.isEmptyObject(f)) for (i in h && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = g && g.display) && (c = $.get(e, "display")), "none" === (u = E.css(e, "display")) && (c ? u = c : (ae([e], !0), c = e.style.display || c, u = E.css(e, "display"), ae([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === E.css(e, "float") && (l || (d.done(function() {
				p.display = c
	...
	E.fn.extend({
		...
		addClass: function(t) {
			...
			if ((e = mt(t)).length) for (; n = this[l++];) if (r = pt(n), i = 1 === n.nodeType && " " + ft(r) + " ") {
		...
		toggleClass: function(r, t) {
			...
			return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : v(r) ? this.each(function(e) {
				...
				var e, t, n, i;
				if (s) for (t = 0, n = E(this), i = mt(r); e = i[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
		...
		hasClass: function(e) {
			var t, n, i = 0;
			for (t = " " + e + " "; n = this[i++];) if (1 === n.nodeType && -1 < (" " + ft(pt(n)) + " ").indexOf(t)) return !0;
			return !1
		}
	});
	...
	function jt(o) {
		return function(e, t) {
			...
			if (v(t)) for (; n = r[i++];)"+" === n[0] ? (n = n.slice(1) || "*", (o[n] = o[n] || []).unshift(t)) : (o[n] = o[n] || []).push(t)
		}
	}
	function zt(t, r, o, s) {
		var a = {},
	...
	for (var H = Math.min, P = Math.floor, j = Math.max, m = "undefined" != typeof window && "undefined" != typeof document, g = ["Edge", "Trident", "Firefox"], y = 0, z = 0; z < g.length; z += 1) if (m && 0 <= navigator.userAgent.indexOf(g[z])) {
		y = 1;
		break
	}
	var Y, R = m && window.Promise ?
	function(e) {
		var t = !1;
		return function() {
				...
				value: function(e, t, n, i) {
					...
					window.setTimeout(function() {
						if (window.clearTimeout(r._showTimeout), !1 !== r._isOpen && document.body.contains(r._tooltipNode)) {
							if ("mouseleave" === i.type) if (r._setTooltipNodeEvent(i, e, t, n)) return;
							r._hide(e, n)
						}
					}, o)
				}
...
default:
	p, h = h && h.hasOwnProperty("default") ? h.
default:
	h;
	var t = "transitionend";
	var m = {
		...
		b = function() {
			...
			return e.toggle = function() {
				...
				if (n) {
					...
					if (i) {
						if ("radio" === i.type) if (i.checked && this._element.classList.contains(x)) e = !1;
						else {
	...
	var S = "carousel",
		...
		P = function() {
			...
			return e.next = function() {
				...
				if (!(e > this._items.length - 1 || e < 0)) if (this._isSliding) p(this._element).one(N.SLID, function() {
					return t.to(e)
				});
				else {
	...
	var K = "dropdown",
		...
		ue = function() {
			...
			return e.toggle = function() {
				...
				if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which)) for (var t = [].slice.call(document.querySelectorAll(se)), n = 0, i = t.length; n < i; n++) {
	...
	var t, n, i, z = L.MutationObserver || L.WebKitMutationObserver || !1,
		...
		a = function(e, t) {
			...
			this.getDocumentScrollOffset = function() {
				...
				if ((b.isie11 || b.isie10) && (n["-ms-overflow-style"] = "none"), x.ishwscroll && (this.doc.css(b.transitionstyle, b.prefixstyle + "transform 0ms ease-out"), b.transitionend && x.bind(x.doc, b.transitionend, x.onScrollTransitionEnd, !1)), x.zindex = "auto", x.ispage || "auto" != _.zindex ? x.zindex = _.zindex : x.zindex = function() {
					...
					function(e) {
						...
						x.hasTextSelected = "getSelection" in N ?
						function() {
			...
			}, _.smoothscroll) if (x.ishwscroll && b.hastransition && _.usetransition && _.smoothscroll) {
				var E = "";
	...
	function r(e, t) {
		return e.isValid() ? (t = N(t, e.localeData()), it[t] = it[t] ||
		function(i) {
	...
	function le(e) {
		var t, n, i, r, o, s, a, l = [];
		if (!e._d) {
			for (s = e, a = void 0, a = new Date(v.now()), i = s._useUTC ? [a.getUTCFullYear(), a.getUTCMonth(), a.getUTCDate()] : [a.getFullYear(), a.getMonth(), a.getDate()], e._w && null == e._a[Et] && null == e._a[Tt] &&
			function(e) {
				var t, n, i, r, o, s, a, l;
	...
	function ce(e) {
		...
		if (l) {
			for (w(e).iso = !0, t = 0, n = Jt.length; t < n; t++) if (Jt[t][1].exec(l[1])) {
				r = Jt[t][0], i = !1 !== Jt[t][2];
				break
			}
			if (null == r) return void(e._isValid = !1);
			if (l[3]) {
				for (t = 0, n = en.length; t < n; t++) if (en[t][1].exec(l[3])) {
					o = (l[2] || " ") + en[t][0];
					break
				}
	...
	function he(e) {
		if (e._f !== v.ISO_8601) if (e._f !== v.RFC_2822) {
			e._a = [], w(e).empty = !0;
	...
	function de(e) {
		...
		return e._locale = e._locale || oe(e._l), null === o || void 0 === s && "" === o ? g({
			nullInput: !0
		}) : ("string" == typeof o && (e._i = o = e._locale.preparse(o)), b(o) ? new _(se(o)) : (h(o) ? e._d = o : a(s) ?
		function(e) {
			var t, n, i, r, o;
	...
	function fe(e, t, n, i, r) {
		...
		return !0 !== n && !1 !== n || (i = n, n = void 0), (l(e) &&
		function(e) {
	...
	function ge(e) {
		...
		this._isValid = function(e) {
			for (var t in e) if (-1 === Nt.call(an, t) || null != e[t] && isNaN(e[t])) return !1;
			for (var n = !1, i = 0; i < an.length; ++i) if (e[an[i]]) {
				if (n) return !1;
	...
	default).map(function(e) {
			...
			var e = function() {
				...
				function r(e, o) {
					if (o) {
						...
						}(e) : Array.isArray(o) ? a(e, o) : "object" === t ?
						function(e, t) {
		...
		e.exports = function(e, t) {
			var n, i, r, o, s, a = e.target,
				l = e.global,
				c = e.stat;
			if (n = l ? u : c ? u[a] || p(a, {}) : (u[a] || {}).prototype) for (i in t) {
	...
	default = function() {
			...
			Array.from(e).forEach(function(e) {
				return function(e) {
					...
					var o = c.
				default [r].toSvg(a({}, n, i, {
						class: (0, l.
					default)(n.class, i.class)
					})),
	...
	default = function(e) {
			...
			if (!r.
		default [e]) throw new Error("No icon matching '" + e + "'. See the complete list of icons at https://feathericons.com");
			return r.
		default [e].toSvg(t)
		}
	}, function(e) {
		...
		var l = function() {
			function i(e, t) {
				...
				}(this), this.name = e, this.contents = t, this.tags = n, this.attrs = r({}, a.
			default, {
			...
			return o(i, [{
				...
				value: function() {
					...
					return "<svg " + (t = r({}, this.attrs, e, {
						class: (0, s.
					default)(this.attrs.class, e.class)
	...
	default = l
		...
		e.exports = function(a) {
			return function(e, t, n) {
				...
				for (; s < o; s++) if ((a || s in r) && r[s] === t) return a || s || 0;
				return !a && -1
			}
		}
	}, function(e, t, n) {
		...
		e.exports = function(e, t, n, i, r, o, s) {
			...
			if (g && (a = x(g.call(new e)), k !== Object.prototype && a.next && (T || x(a) === k || (w ? w(a, k) : "function" != typeof a[C] && b(a, C, D)), _(a, h, !0, !0), T && (E[h] = D))), "values" == r && p && "values" !== p.name && (d = !0, m = function() {
				return p.call(this)
			}), T && !s || f[C] === m || b(f, C, m), E[t] = m, r) if (l = {
				values: u("values"),
				keys: o ? m : u("keys"),
				entries: u("entries")
			}, s) for (c in l)!M && !d && c in f || S(f, c, l[c]);
			else y({
				target: t,
				proto: !0,
				forced: M || d
